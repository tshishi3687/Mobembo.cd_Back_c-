...
namespace Mobembo.cd_Back_c____.Migrations
{
    ...
    [Migration("20220423193317_modif_relation_Coordonnee_ville")]
    partial class modif_relation_Coordonnee_ville
    {
            ...
            modelBuilder.Entity("Mobembo.cd_Back_c____.Data_Access.Entity.Personne", b =>
                {
                    ...
                    b.HasCheckConstraint("CheckMinMail", "LEN(Email)>=6", c => c.HasName("CheckMinMail1"));
            ...
            modelBuilder.Entity("Mobembo.cd_Back_c____.Data_Access.Entity.Province", b =>
                {
                    ...
                    b.HasCheckConstraint("CheckMinMail", "LEN(Description)>=50", c => c.HasName("CheckMinMail2"));
                });
